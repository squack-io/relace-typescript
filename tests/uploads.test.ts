import fs from 'fs';
import type { ResponseLike } from 'relace-agent-sdk/internal/to-file';
import { toFile } from 'relace-agent-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('relace-agent-sdk/core/uploads');
    await expect(
